        ...
        run: async (bot, message, args, config) => {
                ...
                if (config.titre && config.titre.trim() !== '') {
                        container.addTextDisplayComponents(
                                new TextDisplayBuilder().setContent(`## ${config.titre}`)
                        );
                ...
                container.addTextDisplayComponents(
                        new TextDisplayBuilder().setContent(config.description || 'Sélectionnez une option pour ouvrir un ticket')
                );
                ...
                if (config.tfooter && config.tfooter.trim() !== '') {
                        container.addTextDisplayComponents(
                                new TextDisplayBuilder().setContent(`*${config.tfooter}*`)
                        );
                }

                await message.channel.send({ 
                        components: [container, new ActionRowBuilder().addComponents(ticket)],
